...
{
    [TestClass]
    public class SelfManagedTests : UnitTestSiloHost
    {
        ...
        public SelfManagedTests(int dummy)
            : base(new TestingSiloOptions { StartPrimary = true, StartSecondary = false, StartClient = true })
        {
        }

        public SelfManagedTests(bool startClientOnly)
            : base(startClientOnly ?
                        new TestingSiloOptions { StartPrimary = false, StartSecondary = false, StartClient = true } :
                        new TestingSiloOptions { StartFreshOrleans = true })
        {
        }
